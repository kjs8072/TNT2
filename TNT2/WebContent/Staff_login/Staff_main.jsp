      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
            ...
            <h3><a href="<%= request.getContextPath() %>/student_login/TNT_Attend_control.jsp?action=attendance">정보수정</a></h3>
          </div>
        </div> --%>
         ...
         <div class="col-lg-4">
          <div class="features-icons-item mx-auto mb-0 mb-lg-3">
            ...
            <h3><a href="<%= request.getContextPath() %>/Staff_login/Staff_main_control.jsp?action=mypage">Mypage</a></h3>
            <p class="lead mb-0"></p>
          </div>
        </div> 
